...
layout: post
title:  "VGG16 Train!"
summary: "VGG16 Train STL10"
author: cupark
date: '2023-1-5 09:56:23 +0530'
category: NeuralNetwork
thumbnail: /assets/img/posts/VGG16/thumb_vgg16.png
keywords: VGG16_Train
permalink: /blog/VGG16_Train/
usemathjax: true
---
...
#### VGG16 학습하기_STL10  
##### VGG 네트워크는 간단한 구조로 좋은 성능을 보인다.  
##### 224 X 224 X 3 -> 1 X 1 X 1000  
##### Conv2d, MaxPooling, Fully Connected, Relu, Softmax로 구성 되어있다.  

---
<p align="center"><img src="/assets/img/posts/VGG16/vgg16_architecture.png"></p>
...
```
<p align="center"><img src="/assets/img/posts/VGG16/output.png"></p>
...
<p align="center"><img src="/assets/img/posts/VGG16/output2.png"></p>
...
plt.show()
```
<p align="center"><img src="/assets/img/posts/VGG16/loss.png"></p>
...
plt.show()
```
<p align="center"><img src="/assets/img/posts/VGG16/accuracy.png"></p>
